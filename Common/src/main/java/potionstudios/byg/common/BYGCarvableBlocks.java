...
public class BYGCarvableBlocks {
    ...
    public static LazyCollection<Block> addCarverBlocks() {
        return LazyCollection.of(
                ...
                ROCKY_STONE, MOSSY_STONE, OVERGROWN_STONE, LUSH_DIRT, PEAT, WAILING_NYLIUM,
                SYTHIAN_NYLIUM, OVERGROWN_CRIMSON_BLACKSTONE,
                WARPED_SOUL_SAND, WARPED_SOUL_SOIL, BRIMSTONE,
                QUARTZITE_SAND, PENDORITE_ORE, AMETRINE_ORE,
