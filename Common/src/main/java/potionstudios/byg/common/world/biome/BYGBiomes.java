...
public class BYGBiomes {
    ...
    public static final ResourceKey<Biome> BAOBAB_SAVANNA = createBiome("baobab_savanna", BYGOverworldBiomes::baobabSavanna, IS_OVERWORLD, IS_SAVANNA);
    ...
    public static final ResourceKey<Biome> BLACK_FOREST = createBiome("black_forest", BYGOverworldBiomes::blackForest, IS_OVERWORLD, IS_TAIGA);
    ...
    public static final ResourceKey<Biome> PRAIRIE = createBiome("prairie", BYGOverworldBiomes::prairie, IS_OVERWORLD, IS_PLAIN);
    public static final ResourceKey<Biome> RED_OAK_FOREST = createBiome("red_oak_forest", BYGOverworldBiomes::redOakForest, IS_OVERWORLD, IS_FOREST);
    ...
    public static final ResourceKey<Biome> TEMPERATE_RAINFOREST = createBiome("temperate_rainforest", BYGOverworldBiomes::temperateRainForest, IS_OVERWORLD, CLIMATE_TEMPERATE_OVERWORLD, IS_FOREST);
    public static final ResourceKey<Biome> ZELKOVA_FOREST = createBiome("zelkova_forest", BYGOverworldBiomes::zelkovaForest, IS_OVERWORLD, IS_FOREST);
    ...
    public static final ResourceKey<Biome> BASALT_BARRERA = createBiome("basalt_barrera", BYGOverworldBiomes::basaltBarrera, IS_BEACH, IS_OVERWORLD);
    public static final ResourceKey<Biome> DACITE_SHORE = createBiome("dacite_shore", BYGOverworldBiomes::daciteShore, IS_BEACH, IS_OVERWORLD);
    ...
    public static final ResourceKey<Biome> SUBZERO_HYPOGEAL = createBiome("subzero_hypogeal", BYGNetherBiomes::subzeroHypogeal, IS_NETHER, CLIMATE_COLD_NETHER);
