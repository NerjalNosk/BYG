...
public class BYGNetherFeatures {
    ...
    public static final Supplier<RuleTest> NETHERRACK = () -> new BlockMatchTest(Blocks.NETHERRACK);
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PENDORITE = createConfiguredFeature("ore_pendorite", () -> Feature.ORE, () -> new OreConfiguration(NETHERRACK.get(), BYGBlocks.PENDORITE_ORE.defaultBlockState(), 6));
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WAILING_BELL_BLOSSOMS = createConfiguredFeature("wailing_bell_blossom", BYGFeatures.HANGING_FEATURE, () -> new HangingColumnWithBaseConfig.Builder().setBaseBlock(Blocks.NETHERRACK).setBlock(Blocks.CAVE_AIR.defaultBlockState()).setEndBlock(BYGBlocks.WAILING_BELL_BLOSSOM.defaultBlockState()).setMinLength(1).setMaxLength(4).setPlacementFilter(BlockPredicate.matchesBlocks(Blocks.NETHERRACK)).build());
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> HANGING_CHAINS = createConfiguredFeature("hanging_chains", BYGFeatures.HANGING_FEATURE, () -> new HangingColumnWithBaseConfig.Builder().setBaseBlock(Blocks.NETHERRACK).setBlock(Blocks.CHAIN.defaultBlockState()).setEndBlock(Blocks.CHAIN.defaultBlockState()).setMinLength(8).setMaxLength(16).setPlacementFilter(BlockPredicate.matchesBlocks(Blocks.NETHERRACK)).build());
