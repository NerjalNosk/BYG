...
public class BYGPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ALPINE_BELLFLOWER = createPlacedFeature("alpine_bellflower", BYGOverworldVegetationFeatures.ALPINE_BELLFLOWER, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> ROSES = createPlacedFeature("rose", BYGOverworldVegetationFeatures.ROSE, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> BLACK_ROSE = createPlacedFeature("black_rose", BYGOverworldVegetationFeatures.BLACK_ROSE, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> CYAN_ROSE = createPlacedFeature("cyan_rose", BYGOverworldVegetationFeatures.CYAN_ROSE, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> KOVAN_FLOWERS = createPlacedFeature("kovan_flowers", BYGOverworldVegetationFeatures.KOVAN_FLOWER, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> DAISY_ORANGE = createPlacedFeature("orange_daisy", BYGOverworldVegetationFeatures.DAISY_ORANGE, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> JAPANESE_ORCHID = createPlacedFeature("japanese_orchid", BYGOverworldVegetationFeatures.JAPANESE_ORCHID, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> FOXGLOVES = createPlacedFeature("foxgloves", BYGOverworldVegetationFeatures.FOXGLOVE, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> FAIRY_SLIPPER = createPlacedFeature("fairy_slipper", BYGOverworldVegetationFeatures.FAIRY_SLIPPER, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> WINTER_ROSES = createPlacedFeature("winter_roses", BYGOverworldVegetationFeatures.ROSE_WINTER, () -> worldSurfaceSquaredWithCount(3));
    ...
    public static final Holder<PlacedFeature> IRIS = createPlacedFeature("iris", BYGOverworldVegetationFeatures.IRIS, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> TULIPS = createPlacedFeature("tulips", BYGOverworldVegetationFeatures.TULIPS, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> SAGES = createPlacedFeature("sages", BYGOverworldVegetationFeatures.SAGES, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> DAFFODIL_YELLOW = createPlacedFeature("yellow_daffodil", BYGOverworldVegetationFeatures.DAFFODIL_YELLOW, () -> worldSurfaceSquaredWithCount(1));
    public static final Holder<PlacedFeature> JUNGLE_FLOWERS = createPlacedFeature("jungle_flowers", BYGOverworldVegetationFeatures.JUNGLE_FLOWERS, () -> worldSurfaceSquaredWithCount(1));
    ...
    public static final Holder<PlacedFeature> BAYOU_TREES = createPlacedFeature("bayou_trees", BYGOverworldTreeFeatures.BAYOU_TREES, () -> treePlacementBaseOceanFloor(PlacementUtils.countExtra(4, 0.2F, 2), RandomOffsetPlacement.vertical(BiasedToBottomInt.of(3, 5))));
    ...
    public static final Holder<PlacedFeature> ENCHANTED_TREES = createPlacedFeature("enchanted_trees", BYGOverworldTreeFeatures.ENCHANTED_TREES, () -> clearingTreePlacement(PlacementUtils.countExtra(8, 0.2F, 2)));
    ...
    public static final Holder<PlacedFeature> MAPLE_TAIGA_TREES = createPlacedFeature("maple_taiga_trees", BYGOverworldTreeFeatures.MAPLE_TAIGA_TREES, () -> clearingTreePlacement(PlacementUtils.countExtra(4, 0.25F, 2)));
    ...
    public static final Holder<PlacedFeature> HAZEL_TREES = createPlacedFeature("hazel_trees", BYGOverworldTreeFeatures.WITCH_HAZEL_TREES, () -> clearingTreePlacement(PlacementUtils.countExtra(4, 0.25F, 2)));
    public static final Holder<PlacedFeature> IMPARIUS_MUSHROOMS = createPlacedFeature("imparis_mushrooms", BYGEndVegetationFeatures.LARGE_IMPARIUS_MUSHROOMS, () -> treePlacement(PlacementUtils.countExtra(2, 0.25F, 2)));
    ...
    public static final Holder<PlacedFeature> SPARSE_BLUE_SPRUCE_TREES = createPlacedFeature("sparse_blue_spruce_trees", BYGOverworldTreeFeatures.BLUE_SPRUCE_TREES, () -> clearingTreePlacement(PlacementUtils.countExtra(0, 0.2F, 2)));
    ...
    public static final Holder<PlacedFeature> LARGE_BOULDERS = createPlacedFeature("large_boulders", BYGOverworldFeatures.LARGE_BOULDER, () -> oceanFloorSquaredWithCount(1, RarityFilter.onAverageOnceEvery(12), BlockPredicateFilter.forPredicate(DIRT_TAG)));
    public static final Holder<PlacedFeature> LARGE_GRANITE_BOULDERS = createPlacedFeature("large_granite_boulders", BYGOverworldFeatures.LARGE_GRANITE_BOULDER, () -> oceanFloorSquaredWithCount(1, RarityFilter.onAverageOnceEvery(12), BlockPredicateFilter.forPredicate(DIRT_TAG)));
...
//    public static final Holder<PlacedFeature> BRIMSTONE_VENTS = createPlacedFeature("brimstone_vents", BYGNetherFeatures.BRIMSTONE_VENTS, CountOnEveryLayerPlacement () -> .of(4), BiomeFilter::biome);
    ...
    public static final Holder<PlacedFeature> CRAG_DELTA = createPlacedFeature("crag_delta", BYGOverworldFeatures.CRAG_DELTA, () -> oceanFloorSquaredWithCount(1, RandomOffsetPlacement.vertical(ConstantInt.of(-1))));
    public static final Holder<PlacedFeature> SWAMP_MOSS_DELTA = createPlacedFeature("swamp_moss_delta", BYGOverworldFeatures.SWAMP_MOSS_DELTA, () -> oceanFloorSquaredWithCount(1, RandomOffsetPlacement.vertical(ConstantInt.of(-1))));
    public static final Holder<PlacedFeature> SWAMP_GRASS_BLOCK_DELTA = createPlacedFeature("swamp_grass_block_delta", BYGOverworldFeatures.SWAMP_GRASS_BLOCK_DELTA, () -> oceanFloorSquaredWithCount(1, RandomOffsetPlacement.vertical(ConstantInt.of(-1))));
    public static final Holder<PlacedFeature> IMPARIUS_GROVE_DELTA = createPlacedFeature("imparius_grove_delta", BYGEndFeatures.IMPARIUS_GROVE_DELTA, () -> oceanFloorSquaredWithCount(1, RandomOffsetPlacement.vertical(ConstantInt.of(-1))));
