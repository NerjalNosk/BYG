...
//    public static final ResourceKey<PlacedFeature> BRIMSTONE_VENTS = createPlacedFeature("brimstone_vents", BYGNetherFeatures.BRIMSTONE_VENTS, CountOnEveryLayerPlacement () -> .of(4), BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> TALL_CRIMSON_ROOTS = createPlacedFeature("tall_crimson_roots", BYGNetherVegetationFeatures.TALL_CRIMSON_ROOTS, () -> CountOnEveryLayerPlacement.of(4), BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> WEEPING_ROOTS = createPlacedFeature("weeping_roots", BYGNetherVegetationFeatures.WEEPING_ROOTS, () -> CountPlacement.of(10), InSquarePlacement::spread, () -> PlacementUtils.FULL_RANGE, BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> HANGING_LANTERNS = createPlacedFeature("hanging_lanterns", BYGNetherFeatures.WAILING_BELL_BLOSSOMS, () -> CountPlacement.of(10), InSquarePlacement::spread, () -> PlacementUtils.FULL_RANGE, BiomeFilter::biome);
